                ...
                <div class="col-md-10 align-self-center text-center">
                    <div class="404-error-images mb-4">
                        <svg class="w-100 h-100" xmlns="http://www.w3.org/2000/svg" width="965" height="398"
                            ...
                            <text id="_404" data-name="404" class="digit3 h2 fill-dark" x="284.899" y="229.078">4
                                <tspan class="cls-4 fill-primary">0</tspan>4
                            </text>
                        </svg>
                    </div>
                    <div class="404-error-content">
                        ...
                        <a class="btn btn-primary-round btn-round" href="index.html"><i
