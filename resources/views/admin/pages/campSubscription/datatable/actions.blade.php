<div class="btn-group">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
        ...
        <a class="dropdown-item bg-success text-light" href="{{ route('admin.camp_subscription.show', $id) }}">Show</a>


        <a href="javascript:void(0)" data-id="{{ $id }}" data-name="camp_subscription" type="submit"
