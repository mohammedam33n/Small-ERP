                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="input-group mb-4">
                                            ...
                                            <textarea class="form-control @error('body_en') is-invalid @enderror" name="body_en" aria-label="With textarea">{{ old('body_en', $course->getTranslation('body', 'en')) }}</textarea>
                                        </div>
                                        @error('body_en')
                                            <div class="error text-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-6">
                                        <div class="input-group mb-4">
                                            ...
                                            <textarea class="form-control @error('body_ar') is-invalid @enderror" name="body_ar" aria-label="With textarea">{{ old('body_ar', $course->getTranslation('body', 'ar')) }}</textarea>
                                        </div>
                                        @error('body_ar')
                                            <div class="error text-danger">{{ $message }}</div>
                                        @enderror
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="form-group col-md-5 mb-0">
                                                <label for="name" style="color:black;font-weight:bold">Old
                                                    Image:</label>
                                                <img src="{{ asset($course->image) }}" width="200px" height="200px"
                                                    alt=""srcset="">
                                            </div>
                                        </div>
                                    @endif
