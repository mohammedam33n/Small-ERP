<header class="header navbar navbar-expand-sm">
    ...
    <div class="nav-logo align-self-center">
        <a class="navbar-brand" href="{{ route('admin.home') }}">
            <img alt="logo" src="{{ asset('adminAssets/assets/img/90x90.jpg') }}">
            ...
            <nav id="topbar">
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    ...
                    <li class="menu single-menu active">
                        ...
                        <ul class="collapse submenu list-unstyled animated fadeInUp" id="dashboard"
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled animated fadeInUp"
                            id="app"data-parent="#topAccordion">


                            <li class="sub-sub-submenu-list">
                                <a href="#appInvoic_1" data-toggle="collapse" aria-expanded="false"
                                ...
                                <ul class="collapse list-unstyled sub-submenu animated fadeInUp" id="appInvoic_1"
                                    data-parent="#appInvoic_1">
                                    <li>
                                        <a href="{{ route('admin.course.index') }}">
                                            {{ trans('Course.list_course') }}</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.course.create') }}"> {{ trans('Course.create_new_course') }} </a>
                                    </li>
                                </ul>
                            </li>

                            <li class="sub-sub-submenu-list">
                                <a href="#appInvoice_sl" data-toggle="collapse" aria-expanded="false"
                                    class="dropdown-toggle">
                                    {{ trans('sliders.slider') }}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="feather feather-chevron-right">
                                        <polyline points="9 18 15 12 9 6"></polyline>
                                ...
                                <ul class="collapse list-unstyled sub-submenu animated fadeInUp" id="appInvoice_sl"
                                    data-parent="#appInvoice_sl">
                                    <li>
                                        <a href="{{ route('admin.slider.index') }}"> {{ trans('sliders.list_slider') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.slider.create') }}"> {{ trans('Sliders.create_new_slider') }} </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="sub-sub-submenu-list">
                                <a href="#appInvoice_st" data-toggle="collapse" aria-expanded="false"
                                    class="dropdown-toggle">
                                ...
                                <ul class="collapse list-unstyled sub-submenu animated fadeInUp" id="appInvoice_st"
                                    data-parent="#appInvoice_st">
                                    <li>
                                        <a href="{{ route('admin.student.index') }}"> {{ trans('student.students') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.student.create') }}"> {{ trans('student.add_st') }} </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="sub-sub-submenu-list">
                                <a href="#appInvoice_n1" data-toggle="collapse" aria-expanded="false"
                                    class="dropdown-toggle">
                                    {{ trans('Camps.campss') }}
                                ...
                                <ul class="collapse list-unstyled sub-submenu animated fadeInUp" id="appInvoice_n1"
                                    data-parent="#appInvoice_n1">
                                    <li>
                                        <a href="{{ route('admin.camps.index') }}">
                                            {{ trans('Camps.list_camps') }}</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.camps.create') }}"> {{ trans('Camps.create_new_camps') }} </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="sub-sub-submenu-list">
                                ...
                                <ul class="collapse list-unstyled sub-submenu animated fadeInUp" id="appInvoice_n1"
                                    ...
                                    <li>
                                        <a href="{{ route('admin.camp_subscription.index') }}">
                                            {{ trans('Camps.list_camp_subscriptions') }}</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="sub-sub-submenu-list">
                                <a href="#appInvoice_n1" data-toggle="collapse" aria-expanded="false"
                                    class="dropdown-toggle">
                                    {{ trans('Course.course_subscription') }}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
                                        class="feather feather-chevron-right">
                                ...
                                <ul class="collapse list-unstyled sub-submenu animated fadeInUp" id="appInvoice_n1"
                                    ...
                                    <li>
                                        <a href="{{ route('admin.course_subscription.index') }}">
                                            {{ trans('Course.course_subscription') }}</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                        ...
                        <ul class="collapse submenu list-unstyled animated fadeInUp" id="components"
                            ...
                            <li class="sub-sub-submenu-list">
                                <a href="#uiKit" data-toggle="collapse" aria-expanded="false"
                                    class="dropdown-toggle"> UI Kit <svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="feather feather-chevron-right">
                                        <polyline points="9 18 15 12 9 6"></polyline>
                                    </svg> </a>
                                <ul class="collapse list-unstyled sub-submenu animated fadeInUp"
                                    id="uiKit" data-parent="#components">
                                    <li>
                        ...
                        <ul class="collapse submenu list-unstyled animated fadeInUp" id="tables"
                            ...
                            <li class="sub-sub-submenu-list">
                                <a href="#datatable" data-toggle="collapse" aria-expanded="false"
                                    class="dropdown-toggle"> DataTables <svg
                                ...
                                <ul class="collapse list-unstyled sub-submenu animated fadeInUp"
                                    id="datatable" data-parent="#datatable">
                                    <li>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled animated fadeInUp" id="forms"
                            data-parent="#topAccordion">
                            <li>
                    ...
                    <li class="menu single-menu menu-extras">
                        ...
                        <ul class="collapse submenu list-unstyled animated fadeInUp" id="more"
                            data-parent="#topAccordion">
                            <li class="sub-sub-submenu-list">
                                <a href="#page" data-toggle="collapse" aria-expanded="false"
                                    class="dropdown-toggle"> Pages <svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="feather feather-chevron-right">
                                        <polyline points="9 18 15 12 9 6"></polyline>
                                    </svg> </a>
                                <ul class="collapse list-unstyled sub-submenu animated fadeInUp" id="page"
                                    data-parent="#more">
                                    <li>
                                    ...
                                    <li class="sub-sub-submenu-list">
                                        <a href="#pages-error" data-toggle="collapse" aria-expanded="false"
                                            class="dropdown-toggle"> Error <svg xmlns="http://www.w3.org/2000/svg"
                                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round" class="feather feather-chevron-right">
                                                <polyline points="9 18 15 12 9 6"></polyline>
                                        ...
                                        <ul class="collapse list-unstyled sub-submenu animated fadeInUp"
                                            id="pages-error" data-parent="#page">
                                            <li>
                                            ...
                                            <li>
                                                <a href="pages_maintenence.html" target="_blank"> Maintanence
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sub-sub-submenu-list">
                                        <a href="#user-login" data-toggle="collapse" aria-expanded="false"
                                            class="dropdown-toggle"> Login <svg xmlns="http://www.w3.org/2000/svg"
                                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round" class="feather feather-chevron-right">
                                                <polyline points="9 18 15 12 9 6"></polyline>
                                        ...
                                        <ul class="collapse list-unstyled sub-submenu animated fadeInUp"
                                            id="user-login" data-parent="#page">
                                            <li>
                                                <a href="auth_login.html" target="_blank"> Login </a>
                                            </li>
                                            <li>
                                                <a href="auth_login_boxed.html" target="_blank"> Login Boxed
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sub-sub-submenu-list">
                                        <a href="#user-register" data-toggle="collapse" aria-expanded="false"
                                            class="dropdown-toggle"> Register <svg xmlns="http://www.w3.org/2000/svg"
                                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round" class="feather feather-chevron-right">
                                                <polyline points="9 18 15 12 9 6"></polyline>
                                        ...
                                        <ul class="collapse list-unstyled sub-submenu animated fadeInUp"
                                            id="user-register" data-parent="#page">
                                            <li>
                                                <a href="auth_register.html" target="_blank"> Register </a>
                                            </li>
                                            <li>
                                                <a href="auth_register_boxed.html" target="_blank"> Register
                                                    Boxed </a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="sub-sub-submenu-list">
                                        <a href="#user-passRecovery" data-toggle="collapse" aria-expanded="false"
                                            class="dropdown-toggle"> Password Recovery
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-chevron-right">
                                        ...
                                        <ul class="collapse list-unstyled sub-submenu animated fadeInUp"
                                            id="user-passRecovery" data-parent="#page">
                                            <li>
                                                <a href="auth_pass_recovery.html" target="_blank"> Recover ID
                                                </a>
                                            </li>
                                            <li>
                                    ...
                                    <li class="sub-sub-submenu-list">
                                        <a href="#user-lockscreen" data-toggle="collapse" aria-expanded="false"
                                            class="dropdown-toggle"> Lockscreen <svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-chevron-right">
                                        ...
                                        <ul class="collapse list-unstyled sub-submenu animated fadeInUp"
                                            id="user-lockscreen" data-parent="#page">
                                            <li>
                                                <a href="auth_lockscreen.html" target="_blank"> Unlock </a>
                                            </li>
                                            <li>
                                                <a href="auth_lockscreen_boxed.html" target="_blank"> Unlock
                                                    Boxed </a>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <li class="sub-sub-submenu-list">
                                <a href="#starter-kit" data-toggle="collapse" aria-expanded="false"
                                    class="dropdown-toggle"> Starter Kit <svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="feather feather-chevron-right">
                                        <polyline points="9 18 15 12 9 6"></polyline>
                                    </svg> </a>
                                <ul class="collapse list-unstyled sub-submenu animated fadeInUp" id="starter-kit"
                                    data-parent="#more">
                                    <li>
            ...
            <div class="dropdown custom-dropdown-icon">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="customDropdown">
                    ...
                    {{-- <a class="dropdown-item" data-img-value="de" data-value="de" href="javascript:void(0);">
                        <img src="{{ asset('adminAssets/assets/img/de.png') }}" class="flag-width" alt="flag">
                    German
                    </a>
                    <a class="dropdown-item" data-img-value="jp" data-value="jp" href="javascript:void(0);">
                        <img src="{{ asset('adminAssets/assets/img/jp.png') }}" class="flag-width" alt="flag">
                        Japanese
                    </a>
                    <a class="dropdown-item" data-img-value="fr" data-value="fr" href="javascript:void(0);">
                        <img src="{{ asset('adminAssets/assets/img/fr.png') }}" class="flag-width" alt="flag">
                        French
                    </a>
                            ...
                            <div class="media">
                                <div class="user-img">
                                    <div class="avatar avatar-xl">
                                        <img src="{{ asset('adminAssets/assets/img/90x90.jpg') }}" alt="admin-profile">
                                    </div>
                                </div>
            ...
            <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                ...
                <div class="dropdown-item">
                    <a href="javascript:void(0)" onclick="document.getElementById('btn-logout').submit()">
                        ...
                        <form action="{{ route('admin.logout') }}" method="post" id="btn-logout" style="display: none;">
                            @csrf
                            @method('POST')
                        </form>
                    </a>
